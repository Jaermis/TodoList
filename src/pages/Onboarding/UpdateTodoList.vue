    ...
    <div class="create-todo-list">
      <div v-if="!pageLoadingState">
        ...
        <q-form @submit="updateTodo()" greedy class="q-ml-lg q-mt-md">
          ...
          <!-- Task Details -->
          <div v-for="(keyResult, index) in selectedItem.tasks" :key="index">
            <div
            ...
            >
              <q-time v-model="keyResult.time" flat />
...
<script src="./scripts/UpdateTodoList.js"></script>
